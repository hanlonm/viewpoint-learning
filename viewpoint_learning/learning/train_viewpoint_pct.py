...
val_loader = DataLoader(valid_set, 4, False, num_workers=4, collate_fn=pct_transformer_collate, pin_memory=False)
test_loader = DataLoader(test_dataset, 4, False, num_workers=4, collate_fn=pct_transformer_collate, pin_memory=False)
